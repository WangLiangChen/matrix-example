package com.sintrue.example.generator.tier3.service.message_pl;
...
public class StaffRequest extends Pagination {
    ...
    public static StaffRequest newInstance() {
        return ClassUtil.INSTANCE.instantiate(StaffRequest.class);
    }
