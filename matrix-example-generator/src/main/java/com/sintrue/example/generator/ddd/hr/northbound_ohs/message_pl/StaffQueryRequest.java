package com.sintrue.example.generator.ddd.hr.northbound_ohs.message_pl;
 ...
 */
@QueryRequest
public class StaffQueryRequest extends Pagination implements IQueryRequest {
    ...
    public static StaffQueryRequest newInstance() {
        return ClassUtil.INSTANCE.instantiate(StaffQueryRequest.class);
    }
    ...
    public String toString() {
        ...
        builder.append("StaffQueryRequest{");
