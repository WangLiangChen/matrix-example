 ...
 */
@Response
public class StaffQueryResponse implements IResponse {
    ...
    public static StaffQueryResponse newInstance() {
        return ClassUtil.INSTANCE.instantiate(StaffQueryResponse.class);
    }
    ...
    public String toString() {
        ...
        builder.append("StaffQueryResponse{");
