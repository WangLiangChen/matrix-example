 ...
 */
@Response
public class StaffCommandResponse implements IResponse {
    ...
    public static StaffCommandResponse newInstance() {
        return ClassUtil.INSTANCE.instantiate(StaffCommandResponse.class);
    }
    ...
    public String toString() {
        ...
        builder.append("StaffCommandResponse{");
