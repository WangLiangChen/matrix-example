 ...
 */
@CommandRequest
public class StaffCommandRequest implements ICommandRequest {
    ...
    public static StaffCommandRequest newInstance() {
        return ClassUtil.INSTANCE.instantiate(StaffCommandRequest.class);
    }
    ...
    public String toString() {
        ...
        builder.append("StaffCommandRequest{");
